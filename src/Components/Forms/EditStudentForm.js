...
const EditStudentForm = ({student, updateStudentInfo, edited}) => {
    ...
    const {inputs, handleInputChange, handleSubmit} = useForm({
          ...
          teampresent:student.teampresent, 
          nnsid: student.nnsid, 
          bg:student.bg, 
    ...
    return(
        <Form onSubmit={handleSubmit}>
            ...
            <Row md="12" className='mt-4 mb-4'>
                <Col md="5">
                    <Label htmlFor="teampresent">Team Present</Label>
                    <Input type="text" id="teampresent" value={inputs.teampresent} onChange={handleInputChange}></Input>
                </Col>
                <Col md="5">
                    <Label htmlFor="nnsid">NSS ID</Label>
                    <Input type="text" id="nnsid" value={inputs.nnsid} onChange={handleInputChange}></Input>
                </Col>
                <Col md="5" className="mt-2">
                    <Label htmlFor="bg">Blood Group</Label>
                    <Input type="text" id="bg" value={inputs.bg} onChange={handleInputChange}></Input>
                </Col>
            </Row>
            <Row>
                <Col md="12">
